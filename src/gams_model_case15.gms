...
$if not set FILEPATH  $set FILEPATH /case15
$if not set FILENAME  $set FILENAME 05-01
$if not set StartDate $set StartDate 2025-07-15
$if not set StartTime $set StartTime 11:00
...
$call gdxxrw i=data/case15/T1.csv o=TEMP_T1.gdx par=T1 rng=A1 rdim=1 cdim=1
